...
* **If using this on a company PC, you may need to get permission, typically there will be an approved software listing or process.** 
...
| Field | Value |
|---|---|
| **Display Name** | Display Name for the instance, e.g. `Sentinel` |
